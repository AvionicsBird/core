...
class CreateMessageTable extends Migration {
	...
	public function up()
	{
		Schema::create('message', function(Blueprint $table)
		{
			...
			$table->text('forward_signature', 65535)->nullable()->comment('For messages forwarded from channels, signature of the post author if present');
			$table->text('forward_sender_name', 65535)->nullable()->comment('Sender\'s name for messages forwarded from users who disallow adding a link to their account in forwarded messages');
